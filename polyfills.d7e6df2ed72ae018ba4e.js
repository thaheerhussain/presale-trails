            ...
            (function(o) {
                ...
                void 0 === (s = "function" == typeof(r = function() {
                    ...
                    ! function(e) {
                        ...
                        function Z(e, o, s) {
                            ...
                            if (e[g] === v) {
                                ...
                                else if (o !== T && "function" == typeof h) try {
                    ...
                    const g = Zone.__symbol__,
                        ...
                        k = _ ? window : void 0,
                        m = _ && k || "object" == typeof self && self || o,
                        y = [null];
                    ...
                    const T = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
                        ...
                        w = !E && !T && !(!_ || !k.HTMLElement),
                        Z = void 0 !== m.process && "[object process]" === {}.toString.call(m.process) && !T && !(!_ || !k.HTMLElement),
                        S = {},
                        D = function(e) {
                    ...
                    function P(n, o, r) {
                        ...
                        u || (u = S[l] = g("ON_PROPERTY" + l)), s.set = function(e) {
                            let t = this;
                            t || n !== m || (t = m), t && (t[u] && t.removeEventListener(l, D), c && c.apply(t, y), "function" == typeof e ? (t[u] = e, t.addEventListener(l, D, !1)) : t[u] = null)
                        }, s.get = function() {
                            let e = this;
                            if (e || n !== m || (e = m), !e) return null;
                            const t = e[u];
                            if (t) return t;
                            if (a) {
                                let t = a && a.call(this);
                    ...
                    const O = g("originalInstance");

                    function z(e) {
                        const n = m[e];
                        if (!n) return;
                        m[g(e)] = n, m[e] = function() {
                        ...
                        for (r in o) "XMLHttpRequest" === e && "responseBlob" === r || function(n) {
                            "function" == typeof o[n] ? m[e].prototype[n] = function() {
                                ...
                                set: function(t) {
                                    "function" == typeof t ? (this[O][n] = f(t, e + "." + n), N(this[O][n], t)) : this[O][n] = t
                                },
                                get: function() {
                                    return this[O][n]
                                }
                        ...
                        for (r in n) "prototype" !== r && n.hasOwnProperty(r) && (m[e][r] = n[r])
                    }
                    ...
                    function j(t, o, r) {
                        ...
                        const i = g(o);
                        let a = null;
                        if (s && !(a = s[i]) && (a = s[i] = s[o], b(s && e(s, o)))) {
                            const e = r(a, i, o);
                            s[o] = function() {
                    ...
                    function M() {
                        ...
                        R = !0;
                        try {
                            const e = k.navigator.userAgent; - 1 === e.indexOf("MSIE ") && -1 === e.indexOf("Trident/") && -1 === e.indexOf("Edge/") || (x = !0)
                        } catch (e) {}
                        return x
                    }
                    ...
                    function U(e, t, o) {
                        ...
                        function y(t, o) {
                            ...
                            const O = i ? function(e) {
                                    if (!T.isExisting) return w.call(T.target, T.eventName, T.capture ? m : k, T.options)
                                } : function(e) {
                                    return w.call(T.target, T.eventName, e.invoke, T.options)
                                },
                                z = i ? function(e) {
                                    if (!e.isRemoved) {
                                ...
                                x = function(t, n, r, s, c = !1, l = !1) {
                                    return function() {
                                        ...
                                        if (E && "uncaughtException" === f) return t.apply(this, arguments);
                                        let g = !1;
                                        ...
                                        const k = A && !!R && -1 !== R.indexOf(f),
                                            m = C(arguments[2], k);
                                        if (I)
                                            for (let e = 0; e < I.length; e++)
                                                if (f === I[e]) return k ? t.call(p, f, d, m) : t.apply(this, arguments);
                                        ...
                                        const z = p.constructor.name,
                                            N = G[z];
                                        N && (D = N[f]), D || (D = z + n + (b ? b(f) : f)), T.options = m, v && (T.options.once = !1), T.target = p, T.capture = y, T.eventName = f, T.isExisting = O;
                                        const x = i ? H : void 0;
                                        x && (x.taskData = T);
                                        const L = w.scheduleEventTask(D, d, x, r, s);
                                        return T.target = null, x && (x.taskData = null), v && (m.once = !0), (A || "boolean" != typeof L.options) && (L.options = m), L.target = p, L.capture = y, L.eventName = f, g && (L.originalDelegate = d), l ? P.unshift(L) : P.push(L), c ? p : void 0
                                    }
                                };
                            return v[r] = x(w, d, O, z, y), P && (v.prependListener = x(P, ".prependListener:", (function(e) {
                                return P.call(T.target, T.eventName, e.invoke, T.options)
                            }), z, y, !0)), v[s] = function() {
                                const t = this || e;
                                let n = arguments[0];
                                ...
                                if (y) return this
                            }, N(v[r], w), N(v[s], Z), D && N(v[l], D), S && N(v[c], S), !0
                        }
                        let v = [];
                                ...
                                w = j(h, "send", () => function(e, n) {
                                    ...
                                    if (e[o]) return w.apply(e, n); {
                                        const t = {
                                            ...
                                            o = d("XMLHttpRequest.send", y, t, m, v);
